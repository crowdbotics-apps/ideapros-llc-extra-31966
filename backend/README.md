...
## Project Structure
    ...
    ├── ideapros_llc_extra_31966  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_extra_31966`
...
2. Clone this repo and `cd ideapros_llc_extra_31966`
